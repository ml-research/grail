This module is a fork of [https://github.com/k4ntz/HackAtari](https://github.com/k4ntz/HackAtari) 
(commit `f3bf425`).

Changes:
- If a maximum episode length is specified and `frameskip > 1`, truncations might not be handled correctly. 
  This behavior has been changed in [core.py](./hackatari/core.py).
